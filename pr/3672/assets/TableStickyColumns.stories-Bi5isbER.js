...
}`,...k.parameters?.docs?.source},description:{story:"Pin the leading `Name` column to the start edge. Scroll horizontally — the\nname stays put and a drop shadow appears over the scrolling content.",...k.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => {
    const sticky = useTableStickyColumns<Employee>({
      endKeys: ['status']
    });
...
}`,...g.parameters?.docs?.source},description:{story:"Pin the trailing `Status` column to the end edge.",...g.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: () => {
    const sticky = useTableStickyColumns<Employee>({
...
}`,...f.parameters?.docs?.source},description:{story:"Pin both edges at once. `startKeys`/`endKeys` each define a contiguous run\nfrom their edge inward; columns get cumulative offsets so multiple pinned\ncolumns stack correctly.",...f.parameters?.docs?.description}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: () => {
...
whether to install the plugin.`,...S.parameters?.docs?.description}}};const ee=["PinStart","PinEnd","PinBothEdges","WithColumnResize","NoOpEmptyConfig"];export{S as NoOpEmptyConfig,f as PinBothEdges,g as PinEnd,k as PinStart,x as WithColumnResize,ee as __namedExportsOrder,Z as default};
