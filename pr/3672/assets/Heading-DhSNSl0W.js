const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Tooltip-UPeljs0G.js","./iframe-C8fQ-xtn.js","./preload-helper-Ct5FWWRu.js","./iframe-xfvcowIJ.css"])))=>i.map(i=>d[i]);
import{_ as M}from"./preload-helper-Ct5FWWRu.js";import{aO as V,ag as s,a0 as n,a5 as j,ae as v,ax as E,a6 as W,z as B,t as D,a1 as C,aw as A,aP as N,az as f,G as O,C as U,am as F,al as I,v as $,aA as G}from"./iframe-C8fQ-xtn.js";const X=s.lazy(async()=>M(()=>import("./Tooltip-UPeljs0G.js"),__vite__mapDeps([0,1,2,3]),import.meta.url).then(a=>({default:a.Tooltip}))),J={1:"h1",2:"h2",3:"h3",4:"h4",5:"h5",6:"h6"};function y({level:a,type:l,accessibilityLevel:i,color:o="primary",display:h="block",maxLines:e=0,hasTruncateTooltip:r=!0,wordBreak:g,textWrap:d,justify:u="start",hasCapsize:m=!1,hasStrikethrough:b=!1,xstyle:H,className:T,style:w,children:k,ref:S,...x}){const R=J[a],q=i&&i!==a?{"aria-level":i}:{},L=g??(e===1?"break-all":"break-word"),P=e>0||m?"block":h,t=V({maxLines:e}),_=typeof r=="string"?r:"above",c=e>0&&r!==!1&&t.isTruncated,p=s.useRef(null),z=e>1?{WebkitLineClamp:e}:void 0;return n.jsxs(n.Fragment,{children:[n.jsx(R,{ref:W(S,t.ref,p),...j(E("heading",{level:a,color:o,...l&&{type:l}}),v($[o],l?F[l]:I[a],l&&U[l],e===1?f.singleLine:e>1?f.multiLine:O[P],e>0&&N[L],d&&A[d],u!=="start"&&C[u],m&&D.enabled,b&&B.strikethrough,H),T,{...w,...z}),title:c?t.fullText:void 0,...q,...x,children:k}),c&&n.jsx(s.Suspense,{fallback:null,children:n.jsx(X,{anchorRef:p,content:n.jsx("span",{...v(G.content),children:t.fullText}),placement:_})})]})}y.displayName="Heading";y.__docgenInfo={description:`Heading - Semantic heading component
