import{a0 as t,B as b,I as v,ag as e}from"./iframe-C8fQ-xtn.js";import{u as f}from"./AppShellMobileContext-D7-FDHro.js";function n({ref:i,children:l,label:s="Open navigation","data-testid":r,xstyle:u,className:d,style:c}){const{isMobile:p,isMobileNavEnabled:g,toggleMobileNav:m}=f();return!p||!g?null:t.jsx(b,{ref:i,variant:"ghost",label:s,icon:l??t.jsx(v,{icon:"menu",color:"inherit"}),onClick:m,"data-testid":r??"mobile-nav-toggle",xstyle:u,className:d,style:c,isIconOnly:!0})}n.displayName="MobileNavToggle";n.__docgenInfo={description:`Mobile nav toggle button. Reads from AppShell context to open/close
