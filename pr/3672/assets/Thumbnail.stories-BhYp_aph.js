import{ag as l,a0 as e}from"./iframe-C8fQ-xtn.js";import{T as r}from"./Thumbnail-1zhdQxKr.js";import"./preload-helper-Ct5FWWRu.js";import"./Skeleton-BhnpKAwO.js";import"./Tooltip-UPeljs0G.js";import"./useImageMode-BtoDFrv_.js";const L={title:"Core/Thumbnail",component:r,tags:["autodocs"],argTypes:{src:{control:"text",description:"Image source URL"},alt:{control:"text",description:"Alt text for the image"},label:{control:"text",description:"Label below the thumbnail"},isDisabled:{control:"boolean",description:"Whether the thumbnail is disabled"}}},R="https://picsum.photos/id/1042/200/200",i="https://picsum.photos/id/1043/200/200",c="https://picsum.photos/id/1044/200/200",S="https://picsum.photos/id/1047/200/200",d={args:{src:i,alt:"Sample image"}},m={args:{src:c,alt:"Vacation photo",label:"vacation.jpg"}},p={render:()=>{const[s,t]=l.useState(!0);return s?e.jsx(r,{src:i,alt:"Removable thumbnail",label:"photo.png",onRemove:()=>t(!1)}):e.jsxs("p",{style:{color:"#888",fontSize:12},children:["Removed. ",e.jsx("button",{onClick:()=>t(!0),children:"Undo"})]})}},u={render:()=>{const[s,t]=l.useState(!0);return s?e.jsx(r,{src:c,alt:"Photo with metadata",label:"screenshot.png",onRemove:()=>t(!1)}):e.jsxs("p",{style:{color:"#888",fontSize:12},children:["Removed. ",e.jsx("button",{onClick:()=>t(!0),children:"Undo"})]})}},b={args:{src:S,alt:"Clickable thumbnail",onClick:()=>alert("Clicked!"),label:"preview.jpg"}},g={name:"Loading (no preview)",args:{isLoading:!0,label:"uploading.jpg"}},h={name:"Uploading (with preview)",args:{src:c,alt:"Uploading preview",isLoading:!0,label:"vacation.jpg"}},v={name:"No Image (Placeholder)",render:()=>{const[s,t]=l.useState(!0);return s?e.jsx(r,{label:"report.pdf",onRemove:()=>t(!1)}):e.jsxs("p",{style:{color:"#888",fontSize:12},children:["Removed. ",e.jsx("button",{onClick:()=>t(!0),children:"Undo"})]})}},f={args:{src:i,alt:"Disabled thumbnail",label:"locked.jpg",onRemove:()=>{},isDisabled:!0}},j={name:"Media Mode (dark vs light images)",render:function(){const t=[{src:R,label:"dark.jpg",alt:"Dark image"},{src:i,label:"light.jpg",alt:"Light image"},{src:S,label:"mixed.jpg",alt:"Mixed tones"},{src:c,label:"warm.jpg",alt:"Warm tones"}],[n,o]=l.useState(t);return e.jsxs("div",{children:[e.jsx("p",{style:{fontSize:12,color:"#888",marginBottom:8},children:"Remove buttons should adapt: light icon on dark images, dark icon on light images."}),e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"flex-start"},children:[n.map(a=>e.jsx(r,{src:a.src,alt:a.alt,label:a.label,onRemove:()=>o(M=>M.filter(x=>x.label!==a.label))},a.label)),n.length===0&&e.jsxs("p",{style:{color:"#888",fontSize:12},children:["All removed."," ",e.jsx("button",{onClick:()=>o(t),children:"Reset"})]})]})]})}},I={render:function(){const t=[{id:1,src:R,label:"dark.jpg"},{id:2,src:i,label:"light.jpg"},{id:4,src:c,label:"warm.jpg"}],[n,o]=l.useState(t);return e.jsxs("div",{style:{display:"flex",gap:8,alignItems:"flex-start"},children:[n.map(a=>e.jsx(r,{src:a.src,alt:a.label,label:a.label,onRemove:()=>o(M=>M.filter(x=>x.id!==a.id))},a.id)),n.length===0&&e.jsxs("p",{style:{color:"#888",fontSize:12},children:["All removed."," ",e.jsx("button",{onClick:()=>o(t),children:"Reset"})]})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    src: LIGHT_IMAGE,
    alt: 'Sample image'
  }
